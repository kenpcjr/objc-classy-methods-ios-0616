...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSArray *classyDrinks =[NSArray arrayWithObjects:@"Old Fashioned", @"Churchill Martini", @"Proseco", nil];
    NSLog(@"%@", classyDrinks);
    
    NSDictionary *classByLiteral =@{ @"classy things" : @[@"monocle",
                                                          @"top hat",
                                                          @"martini glass"],
